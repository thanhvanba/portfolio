...
export default function Home() {
  return (
    <div className="flex flex-col md:flex-row w-full ">
      ...
      <div className="md:w-1/2 flex md:flex-col justify-center px-4">
        <div className="w-3/5 md:w-full" >
          <p className="text-2xl md:text-6xl font-semibold">Hi There,</p>
          <p className="text-2xl md:text-6xl font-semibold">I'm <span className="text-[#ff7b00]">Thanh Van</span></p>
          <ChangingTitle />
        </div>
        <div className="w-2/5 md:w-full">
          <div className="flex flex-col md:flex-row space-x-4 mt-8">
            ...
            <a className="text-base md:text-2xl underline" href="">Contact</a>
          </div>
        </div>
      </div>
    </div>
